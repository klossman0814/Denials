...
const Remittance = sequelize.define('Remittance', {
  ...
  patient_responsibility: { type: DataTypes.DECIMAL(10, 2) },
  amount_paid_other_payer: { type: DataTypes.DECIMAL(10, 2) },
  adjustment_amount: { type: DataTypes.DECIMAL(10, 2), defaultValue: 0 },
  remittance_date: { type: DataTypes.DATEONLY },
  status: { type: DataTypes.STRING(20), defaultValue: 'pending', validate: { isIn: [['pending', 'paid', 'denied', 'partial', 'replaced']] } },
