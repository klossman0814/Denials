...
const Claim = sequelize.define('Claim', {
  ...
  patient_middle_initial: { type: DataTypes.STRING(10) },
  patient_suffix: { type: DataTypes.STRING(10) },
  ...
  subscriber_middle_initial: { type: DataTypes.STRING(10) },
  subscriber_suffix: { type: DataTypes.STRING(10) },
